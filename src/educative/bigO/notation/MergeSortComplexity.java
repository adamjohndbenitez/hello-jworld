package educative.bigO.notation;
...
//        System.out.println("after sort first half" + Arrays.toString(input));

        // sort second half
        mergeSort(mid + 1, end, input);
//        System.out.println("after sort second half" + Arrays.toString(input));
